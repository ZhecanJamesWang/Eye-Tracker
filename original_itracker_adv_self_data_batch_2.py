	...
	def train(self, lr=1e-3, batch_size=128, max_epoch=1000, min_delta=1e-4, patience=10, print_per_epoch=10, out_model='my_model'):
		...
		with tf.Session() as sess:
			...
			for n_epoch in range(1, max_epoch + 1):
				...
				val_data = load_batch_from_data(val_names, dataset_path, batch_size, img_ch, img_cols, img_rows, train_start = test_start, train_end = test_end)
...
def main():
	...
	parser.add_argument('-max_epoch', '--max_epoch', type=int, default=3, help='max number of iterations')
