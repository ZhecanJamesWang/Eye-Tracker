...
def load_batch_from_data(mtcnn_h, names, path, batch_size, img_ch, img_cols, img_rows, train_start = None, train_end = None):
    ...
    for i in range(int(train_start),int(train_end)):
        ...
        try:
            ...
            result = mtcnn_h.run_mtcnn(frame,  if_face = True, if_facemask = True, if_draw = False)
...
def save_data_to_tfrecord(mtcnn_h, names, path, batch_size, img_ch, img_cols, img_rows):
    save_img = False
